...
# Add the directory containing gs_viewer.py to the Python path
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="data/truck/model.ply", help="Path to ply model")
    args = parser.parse_args()

    print(f"[GS Viewer] Rendering {args.model_path}")
