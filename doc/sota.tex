...
\begin{figure}[!htb]
    ...
    \caption{Optymalizacja zbioru splatów}
\end{figure}

\begin{enumerate}
    \item Wykorzystanie chmury punktów z rekonstrukcji do inicjalizacji zbioru splatów
    \item Rzutowanie perspektywiczne 3-wymiarowych gaussianów na obraz widziany z danej kamery 
    ...
    \item Adaptacja gęstości gaussianów - klonowanie, dzielenie lub usuwanie
\end{enumerate}
